...
int main()
{
    ...
    case 1:
        if (populacao1 > populacao2)
            printf("Cidade 1 venceu na População.\n");
        else if (populacao1 < populacao2)
            printf("Cidade 2 venceu na População.\n");
        else
    ...
    case 2:
        if (area1 > area2)
            printf("Cidade 1 venceu na Área.\n");
        else if (area1 < area2)
            printf("Cidade 2 venceu na Área.\n");
        else
    ...
    case 3:
        if (pib1 > pib2)
            printf("Cidade 1 venceu no PIB.\n");
        else if (pib1 < pib2)
            printf("Cidade 2 venceu no PIB.\n");
        else
    ...
    case 5:
        if (Densidade_populacional1 > Densidade_populacional2)
            printf("Cidade 2 venceu na Densidade Populacional.\n");
        else if (Densidade_populacional1 < Densidade_populacional2)
            printf("Cidade 1 venceu na Densidade Populacional.\n");
        else
    ...
    case 6:
        if (PIB_per_capita1 > PIB_per_capita2)
            printf("Cidade 1 venceu no PIB per capita.\n");
        else if (PIB_per_capita1 < PIB_per_capita2)
            printf("Cidade 2 venceu no PIB per capita.\n");
        else
    ...
    // Após as comparações, determine qual carta venceu com base no atributo escolhido.
